...
//   const ownerInfo = useSelector((state) => state.hostel.ownerId);
//   console.log(owner)
...
// export default AppRoutes;
// AppRoutes.jsx (your existing code)
import React, { useEffect } from "react";
import { BrowserRouter, Route, Routes as RouterRoutes } from "react-router-dom";
import { useDispatch, useSelector } from "react-redux";

// Screens (imports as before)
import Signup from "./signup/Signup";
import Signin from "./Signin/Signin";
import ResetPassword from "./Signin/ResetPassword";
import Register from "./signup/Register";
...
import Comparison from "./components/Comparison";
import Details from "./Hostel Details/Details";
// Remove direct Booking import now
import Payment from "./Booking Forms/Payment";
import Ratings from "./Ratings Feedback/Ratings";
import Notifications from "./components/Notifications";
import Profile from "./Profile/Profile";
...
import PrivateRoute from "./private";
import { getUserProfile } from "./Features/authSlics";
import BookingWrapper from "./BookingWrapper"; // Import wrapper here
  ...
  return (
    <BrowserRouter>
      <RouterRoutes>
        ...
        {/* Use BookingWrapper instead of Booking */}
        <Route
          path="/Booking"
          element={
            <PrivateRoute>
